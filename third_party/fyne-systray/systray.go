...
// SetVisible shows or hides the tray icon without tearing down the systray or
// the process behind it. Hiding leaves the app running headless ("stealth"):
// no icon, no menu, but the node keeps working. Added for Turbo; not part of
// upstream fyne.io/systray.
